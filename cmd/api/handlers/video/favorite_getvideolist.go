...
func GetFavoriteVideoList(ctx context.Context, c *app.RequestContext) {
	var GetFavoriteVideo GetFavoriteVideoListParam
	var err error
	var v interface{}
	var UserId int64

	if err = c.Bind(&GetFavoriteVideo); err != nil {
		hlog.Info(err)
