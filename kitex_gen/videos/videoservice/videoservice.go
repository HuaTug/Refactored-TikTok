...
var serviceMethods = map[string]kitex.MethodInfo{
	...
	"ImageFeatureExtract": kitex.NewMethodInfo(
		imageFeatureExtractHandler,
		newVideoServiceImageFeatureExtractArgs,
		newVideoServiceImageFeatureExtractResult,
		false,
		kitex.WithStreamingMode(kitex.StreamingNone),
	),
	"ImageSearch": kitex.NewMethodInfo(
		imageSearchHandler,
		newVideoServiceImageSearchArgs,
		newVideoServiceImageSearchResult,
		false,
		kitex.WithStreamingMode(kitex.StreamingNone),
	),
	"VideoKeyFrameExtract": kitex.NewMethodInfo(
		videoKeyFrameExtractHandler,
		newVideoServiceVideoKeyFrameExtractArgs,
		newVideoServiceVideoKeyFrameExtractResult,
		false,
		kitex.WithStreamingMode(kitex.StreamingNone),
	),
	"BatchImageProcess": kitex.NewMethodInfo(
		batchImageProcessHandler,
		newVideoServiceBatchImageProcessArgs,
		newVideoServiceBatchImageProcessResult,
		false,
		kitex.WithStreamingMode(kitex.StreamingNone),
	),
	"ImageIndexManage": kitex.NewMethodInfo(
		imageIndexManageHandler,
		newVideoServiceImageIndexManageArgs,
		newVideoServiceImageIndexManageResult,
		false,
		kitex.WithStreamingMode(kitex.StreamingNone),
	),
	"SimilarityAnalysis": kitex.NewMethodInfo(
		similarityAnalysisHandler,
		newVideoServiceSimilarityAnalysisArgs,
		newVideoServiceSimilarityAnalysisResult,
		false,
		kitex.WithStreamingMode(kitex.StreamingNone),
	),
}
...
func imageFeatureExtractHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	realArg := arg.(*videos.VideoServiceImageFeatureExtractArgs)
	realResult := result.(*videos.VideoServiceImageFeatureExtractResult)
	success, err := handler.(videos.VideoService).ImageFeatureExtract(ctx, realArg.Req)
	if err != nil {
		return err
	}
	realResult.Success = success
...
func newVideoServiceImageFeatureExtractArgs() interface{} {
	return videos.NewVideoServiceImageFeatureExtractArgs()
}

func newVideoServiceImageFeatureExtractResult() interface{} {
	return videos.NewVideoServiceImageFeatureExtractResult()
}

func imageSearchHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	realArg := arg.(*videos.VideoServiceImageSearchArgs)
	realResult := result.(*videos.VideoServiceImageSearchResult)
	success, err := handler.(videos.VideoService).ImageSearch(ctx, realArg.Req)
	if err != nil {
		return err
	}
	realResult.Success = success
...
func newVideoServiceImageSearchArgs() interface{} {
	return videos.NewVideoServiceImageSearchArgs()
}

func newVideoServiceImageSearchResult() interface{} {
	return videos.NewVideoServiceImageSearchResult()
}

func videoKeyFrameExtractHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	realArg := arg.(*videos.VideoServiceVideoKeyFrameExtractArgs)
	realResult := result.(*videos.VideoServiceVideoKeyFrameExtractResult)
	success, err := handler.(videos.VideoService).VideoKeyFrameExtract(ctx, realArg.Req)
	if err != nil {
		return err
	}
	realResult.Success = success
...
func newVideoServiceVideoKeyFrameExtractArgs() interface{} {
	return videos.NewVideoServiceVideoKeyFrameExtractArgs()
}

func newVideoServiceVideoKeyFrameExtractResult() interface{} {
	return videos.NewVideoServiceVideoKeyFrameExtractResult()
}

func batchImageProcessHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	realArg := arg.(*videos.VideoServiceBatchImageProcessArgs)
	realResult := result.(*videos.VideoServiceBatchImageProcessResult)
	success, err := handler.(videos.VideoService).BatchImageProcess(ctx, realArg.Req)
	if err != nil {
		return err
	}
	realResult.Success = success
...
func newVideoServiceBatchImageProcessArgs() interface{} {
	return videos.NewVideoServiceBatchImageProcessArgs()
}

func newVideoServiceBatchImageProcessResult() interface{} {
	return videos.NewVideoServiceBatchImageProcessResult()
}

func imageIndexManageHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	realArg := arg.(*videos.VideoServiceImageIndexManageArgs)
	realResult := result.(*videos.VideoServiceImageIndexManageResult)
	success, err := handler.(videos.VideoService).ImageIndexManage(ctx, realArg.Req)
	if err != nil {
		return err
	}
	realResult.Success = success
...
func newVideoServiceImageIndexManageArgs() interface{} {
	return videos.NewVideoServiceImageIndexManageArgs()
}

func newVideoServiceImageIndexManageResult() interface{} {
	return videos.NewVideoServiceImageIndexManageResult()
}

func similarityAnalysisHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	realArg := arg.(*videos.VideoServiceSimilarityAnalysisArgs)
	realResult := result.(*videos.VideoServiceSimilarityAnalysisResult)
	success, err := handler.(videos.VideoService).SimilarityAnalysis(ctx, realArg.Req)
	if err != nil {
		return err
	}
	realResult.Success = success
...
func newVideoServiceSimilarityAnalysisArgs() interface{} {
	return videos.NewVideoServiceSimilarityAnalysisArgs()
}

func newVideoServiceSimilarityAnalysisResult() interface{} {
	return videos.NewVideoServiceSimilarityAnalysisResult()
}
...
func (p *kClient) ImageFeatureExtract(ctx context.Context, req *videos.ImageFeatureExtractRequest) (r *videos.ImageFeatureExtractResponse, err error) {
	var _args videos.VideoServiceImageFeatureExtractArgs
	_args.Req = req
	var _result videos.VideoServiceImageFeatureExtractResult
	if err = p.c.Call(ctx, "ImageFeatureExtract", &_args, &_result); err != nil {
		return
	}
	return _result.GetSuccess(), nil
}

func (p *kClient) ImageSearch(ctx context.Context, req *videos.ImageSearchRequest) (r *videos.ImageSearchResponse, err error) {
	var _args videos.VideoServiceImageSearchArgs
	_args.Req = req
	var _result videos.VideoServiceImageSearchResult
	if err = p.c.Call(ctx, "ImageSearch", &_args, &_result); err != nil {
		return
	}
	return _result.GetSuccess(), nil
}

func (p *kClient) VideoKeyFrameExtract(ctx context.Context, req *videos.VideoKeyFrameExtractRequest) (r *videos.VideoKeyFrameExtractResponse, err error) {
	var _args videos.VideoServiceVideoKeyFrameExtractArgs
	_args.Req = req
	var _result videos.VideoServiceVideoKeyFrameExtractResult
	if err = p.c.Call(ctx, "VideoKeyFrameExtract", &_args, &_result); err != nil {
		return
	}
	return _result.GetSuccess(), nil
}

func (p *kClient) BatchImageProcess(ctx context.Context, req *videos.BatchImageProcessRequest) (r *videos.BatchImageProcessResponse, err error) {
	var _args videos.VideoServiceBatchImageProcessArgs
	_args.Req = req
	var _result videos.VideoServiceBatchImageProcessResult
	if err = p.c.Call(ctx, "BatchImageProcess", &_args, &_result); err != nil {
		return
	}
	return _result.GetSuccess(), nil
}

func (p *kClient) ImageIndexManage(ctx context.Context, req *videos.ImageIndexManageRequest) (r *videos.ImageIndexManageResponse, err error) {
	var _args videos.VideoServiceImageIndexManageArgs
	_args.Req = req
	var _result videos.VideoServiceImageIndexManageResult
	if err = p.c.Call(ctx, "ImageIndexManage", &_args, &_result); err != nil {
		return
	}
	return _result.GetSuccess(), nil
}

func (p *kClient) SimilarityAnalysis(ctx context.Context, req *videos.SimilarityAnalysisRequest) (r *videos.SimilarityAnalysisResponse, err error) {
	var _args videos.VideoServiceSimilarityAnalysisArgs
	_args.Req = req
	var _result videos.VideoServiceSimilarityAnalysisResult
	if err = p.c.Call(ctx, "SimilarityAnalysis", &_args, &_result); err != nil {
		return
	}
	return _result.GetSuccess(), nil
}
